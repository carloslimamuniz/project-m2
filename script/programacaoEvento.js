...
// Criando mentores
const mentors = [
    new Mentor("Dr. Oscar the Grouch", "Diretor de Lixo", "Especialista em gestão de resíduos.", "../src/Assets/oscar de Vila Sésamo.png"),
    new Mentor("Dr. Wall-e", "Ministro do Meio Ambiente", "16 anos de experiência em educação ambiental.", "../src/Assets/walle.png")
];
